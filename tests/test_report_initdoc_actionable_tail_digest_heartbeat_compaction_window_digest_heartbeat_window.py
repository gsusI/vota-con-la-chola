...
from scripts.report_initdoc_actionable_tail_digest_heartbeat_compaction_window_digest_heartbeat_window import main


class TestInitdocActionableTailCompactionWindowDigestHeartbeatWindow(unittest.TestCase):
