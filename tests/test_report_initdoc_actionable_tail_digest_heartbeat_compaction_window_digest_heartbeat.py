...
from scripts.report_initdoc_actionable_tail_digest_heartbeat_compaction_window_digest_heartbeat import main


class TestInitdocActionableTailCompactionWindowDigestHeartbeat(unittest.TestCase):
    def _write_digest(
        self,
        path: Path,
        *,
        ...
        payload = {
            ...
            "input": {
                "compaction_window_generated_at": "2026-02-23T08:59:59+00:00",
                "heartbeat_path": "/tmp/initdoc_hb.jsonl",
                "compacted_path": "/tmp/initdoc_hb.compacted.jsonl",
            },
            "status": status,
