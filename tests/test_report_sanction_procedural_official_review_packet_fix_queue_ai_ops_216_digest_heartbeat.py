...
from scripts.report_sanction_procedural_official_review_packet_fix_queue_ai_ops_216_digest_heartbeat import (
    main,
)


class TestSanctionProceduralPacketFixAiOps216DigestHeartbeat(unittest.TestCase):
    def _write_digest(
        self,
        path: Path,
        *,
        ...
        payload = {
            ...
            "input": {
                "compaction_window_generated_at": "2026-02-24T15:59:59+00:00",
