...
from scripts.report_initdoc_actionable_tail_digest_heartbeat_compaction_window_digest_heartbeat_compaction import main


class TestInitdocActionableTailDigestHeartbeatCompactWindowDigestHeartbeatCompaction(unittest.TestCase):
    def _hb(self, minute: int, *, status: str = "ok", strict_fail_count: int = 0, risk_level: str = "green") -> dict[str, object]:
        ...
        return {
            "run_at": f"2026-02-23T12:{mm}:00+00:00",
