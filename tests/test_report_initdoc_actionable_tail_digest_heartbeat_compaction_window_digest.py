...
from scripts.report_initdoc_actionable_tail_digest_heartbeat_compaction_window_digest import main


class TestInitdocActionableTailCompactionWindowDigest(unittest.TestCase):
    ...
    def test_digest_ok_strict_when_parity_is_clean(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(list(digest.get("validation_errors") or []), [])
