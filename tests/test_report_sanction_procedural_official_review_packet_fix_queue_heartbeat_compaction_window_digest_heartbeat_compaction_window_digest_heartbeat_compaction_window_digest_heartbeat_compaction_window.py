...
from scripts.report_sanction_procedural_official_review_packet_fix_queue_heartbeat_compaction_window_digest_heartbeat_compaction_window_digest_heartbeat_compaction_window_digest_heartbeat_compaction_window import (
    main,
)


class TestSanctionProceduralPacketFixCompactionWindowDigestHeartbeatCompactionWindowDigestHeartbeatCompactionWindowDigestHeartbeatCompactionWindow(unittest.TestCase):
