...
class TestInitdocActionableTailCompactWindowDigestHeartbeatCompactionWindowDigest(unittest.TestCase):
    ...
    def _parity(self, **overrides: object) -> dict[str, object]:
        base: dict[str, object] = {
            ...
            "heartbeat_path": "/tmp/initdoc_cd_trend_hb.jsonl",
            "compacted_path": "/tmp/initdoc_cd_trend_hb.compacted.jsonl",
