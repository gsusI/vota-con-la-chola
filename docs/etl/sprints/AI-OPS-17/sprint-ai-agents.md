...
Objective:
- Lock AI-OPS-17 scope, gate contract, and anti-loop policy for external blockers.
...
Output contract:
- docs/etl/sprints/AI-OPS-17/kickoff.md
- docs/etl/sprints/AI-OPS-17/reports/scope-lock.md

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/kickoff.md
- rg -n "Scope Lock|Must-pass gates|Escalation rules" docs/etl/sprints/AI-OPS-17/kickoff.md
...
- rg -n "programas_declared_total|strict gate|overall_match" docs/etl/sprints/AI-OPS-17/reports/query-pack-baseline.md
...
Output contract:
- docs/etl/sprints/AI-OPS-17/reports/programas-source-contract.md
- etl/data/raw/samples/programas_partidos_sample.csv

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/reports/programas-source-contract.md
- test -f etl/data/raw/samples/programas_partidos_sample.csv
- rg -n "source_id=programas_partidos|identity key|manifest" docs/etl/sprints/AI-OPS-17/reports/programas-source-contract.md
...
depends_on: [1]
parallel_group: P3
artifact_path: docs/etl/sprints/AI-OPS-17/reports/programas-source-contract.md
```
...
- docs/etl/sprints/AI-OPS-17/reports/programas-pipeline-design.md
...
- test -f docs/etl/sprints/AI-OPS-17/reports/programas-pipeline-design.md
...
depends_on: [1,3]
parallel_group: P4
artifact_path: docs/etl/sprints/AI-OPS-17/reports/programas-pipeline-design.md
```
...
- docs/etl/sprints/AI-OPS-17/reports/programas-pipeline-tests.md

Acceptance checks:
- test -f tests/test_parl_programas_partidos.py
- test -f docs/etl/sprints/AI-OPS-17/reports/programas-pipeline-tests.md
...
depends_on: [4]
parallel_group: P5
artifact_path: docs/etl/sprints/AI-OPS-17/reports/programas-pipeline-tests.md
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/reports/fast-wave-checklist.md

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/reports/fast-wave-checklist.md
- rg -n "Task 8|Task 20|no-op|snapshot" docs/etl/sprints/AI-OPS-17/reports/fast-wave-checklist.md
...
depends_on: [2,5]
parallel_group: P6
artifact_path: docs/etl/sprints/AI-OPS-17/reports/fast-wave-checklist.md
```
...
- rg -n "GO|NO-GO|lane order|blocker policy" docs/etl/sprints/AI-OPS-17/reports/setup-wave-signoff.md
...
Output contract:
- docs/etl/sprints/AI-OPS-17/evidence/tracker-status-baseline.log
- docs/etl/sprints/AI-OPS-17/evidence/baseline-gate.log
- docs/etl/sprints/AI-OPS-17/exports/programas_kpi_baseline.csv

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/evidence/tracker-status-baseline.log
- test -f docs/etl/sprints/AI-OPS-17/evidence/baseline-gate.log
- test -f docs/etl/sprints/AI-OPS-17/exports/programas_kpi_baseline.csv
...
depends_on: [2,6,7]
parallel_group: P8
artifact_path: docs/etl/sprints/AI-OPS-17/exports/programas_kpi_baseline.csv
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/exports/program_manifest_input.csv

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/exports/program_manifest_input.csv
- python3 - <<'PY'
import csv
from pathlib import Path
p=Path('docs/etl/sprints/AI-OPS-17/exports/program_manifest_input.csv')
...
depends_on: [6,7]
parallel_group: P9
artifact_path: docs/etl/sprints/AI-OPS-17/exports/program_manifest_input.csv
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/evidence/program-manifest-validate.log
- docs/etl/sprints/AI-OPS-17/reports/program-manifest-validation.md

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/evidence/program-manifest-validate.log
- test -f docs/etl/sprints/AI-OPS-17/reports/program-manifest-validation.md
- rg -n "duplicates|malformed|missing|status" docs/etl/sprints/AI-OPS-17/reports/program-manifest-validation.md
...
depends_on: [9]
parallel_group: P10
artifact_path: docs/etl/sprints/AI-OPS-17/reports/program-manifest-validation.md
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/evidence/programas_ingest.log
- docs/etl/sprints/AI-OPS-17/exports/programas_ingest_metrics.csv

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/evidence/programas_ingest.log
- test -f docs/etl/sprints/AI-OPS-17/exports/programas_ingest_metrics.csv
- rg -n "records_loaded|source_id=programas_partidos" docs/etl/sprints/AI-OPS-17/evidence/programas_ingest.log
...
depends_on: [4,10]
parallel_group: P11
artifact_path: docs/etl/sprints/AI-OPS-17/evidence/programas_ingest.log
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/evidence/programas_textdocs_backfill.log
- docs/etl/sprints/AI-OPS-17/exports/programas_textdocs_metrics.csv

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/evidence/programas_textdocs_backfill.log
- test -f docs/etl/sprints/AI-OPS-17/exports/programas_textdocs_metrics.csv
- rg -n "text_documents_total|with_excerpt" docs/etl/sprints/AI-OPS-17/exports/programas_textdocs_metrics.csv
...
depends_on: [11]
parallel_group: P12
artifact_path: docs/etl/sprints/AI-OPS-17/exports/programas_textdocs_metrics.csv
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/evidence/programas_stance_pass1.log
- docs/etl/sprints/AI-OPS-17/exports/programas_stance_pass1_metrics.csv

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/evidence/programas_stance_pass1.log
- test -f docs/etl/sprints/AI-OPS-17/exports/programas_stance_pass1_metrics.csv
- rg -n "declared_with_signal|review_pending" docs/etl/sprints/AI-OPS-17/exports/programas_stance_pass1_metrics.csv
...
depends_on: [2,4,12]
parallel_group: P13
artifact_path: docs/etl/sprints/AI-OPS-17/exports/programas_stance_pass1_metrics.csv
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/evidence/programas_stance_pass2.log
- docs/etl/sprints/AI-OPS-17/exports/programas_stance_pass2_metrics.csv

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/evidence/programas_stance_pass2.log
- test -f docs/etl/sprints/AI-OPS-17/exports/programas_stance_pass2_metrics.csv
- rg -n "declared_with_signal|review_pending" docs/etl/sprints/AI-OPS-17/exports/programas_stance_pass2_metrics.csv
...
depends_on: [2,4,12]
parallel_group: P13
artifact_path: docs/etl/sprints/AI-OPS-17/exports/programas_stance_pass2_metrics.csv
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/reports/programas_threshold_selection.md
- docs/etl/sprints/AI-OPS-17/exports/programas_stance_selected_metrics.csv

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/reports/programas_threshold_selection.md
- test -f docs/etl/sprints/AI-OPS-17/exports/programas_stance_selected_metrics.csv
- rg -n "selected_threshold|tie-break|decision" docs/etl/sprints/AI-OPS-17/reports/programas_threshold_selection.md
...
depends_on: [13,14]
parallel_group: P14
artifact_path: docs/etl/sprints/AI-OPS-17/reports/programas_threshold_selection.md
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/evidence/programas_review_queue.log
- docs/etl/sprints/AI-OPS-17/exports/programas_review_queue_snapshot.csv

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/evidence/programas_review_queue.log
- test -f docs/etl/sprints/AI-OPS-17/exports/programas_review_queue_snapshot.csv
- rg -n "review_reason|pending" docs/etl/sprints/AI-OPS-17/exports/programas_review_queue_snapshot.csv
...
depends_on: [15]
parallel_group: P15
artifact_path: docs/etl/sprints/AI-OPS-17/exports/programas_review_queue_snapshot.csv
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/exports/programas_review_batch_a_input.csv
- docs/etl/sprints/AI-OPS-17/reports/programas_review_batch_prep.md

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/exports/programas_review_batch_a_input.csv
- test -f docs/etl/sprints/AI-OPS-17/reports/programas_review_batch_prep.md
- rg -n "batch_size|filter|ordering" docs/etl/sprints/AI-OPS-17/reports/programas_review_batch_prep.md
...
depends_on: [16]
parallel_group: P16
artifact_path: docs/etl/sprints/AI-OPS-17/exports/programas_review_batch_a_input.csv
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/evidence/programas_review_batch_apply.log
- docs/etl/sprints/AI-OPS-17/exports/programas_review_batch_apply_metrics.csv

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/evidence/programas_review_batch_apply.log
- test -f docs/etl/sprints/AI-OPS-17/exports/programas_review_batch_apply_metrics.csv
- rg -n "applied|resolved|ignored|no-op" docs/etl/sprints/AI-OPS-17/evidence/programas_review_batch_apply.log
...
depends_on: [17]
parallel_group: P17
artifact_path: docs/etl/sprints/AI-OPS-17/evidence/programas_review_batch_apply.log
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/evidence/programas_positions_recompute.log
- docs/etl/sprints/AI-OPS-17/exports/programas_topic_positions_post.csv
- docs/etl/sprints/AI-OPS-17/exports/programas_coherence_post.csv

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/evidence/programas_positions_recompute.log
- test -f docs/etl/sprints/AI-OPS-17/exports/programas_topic_positions_post.csv
- test -f docs/etl/sprints/AI-OPS-17/exports/programas_coherence_post.csv
...
depends_on: [15,18]
parallel_group: P18
artifact_path: docs/etl/sprints/AI-OPS-17/exports/programas_topic_positions_post.csv
```
...
- docs/etl/sprints/AI-OPS-17/reports/final-gate-parity.md

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/evidence/tracker-gate-postrun.exit
- test -f docs/etl/sprints/AI-OPS-17/evidence/status-postrun.json
- test -f docs/etl/sprints/AI-OPS-17/evidence/status-parity-postrun.txt
- rg -n "overall_match=true|mismatches=0|waivers_expired=0|done_zero_real=0" docs/etl/sprints/AI-OPS-17/reports/final-gate-parity.md
...
depends_on: [8,19]
parallel_group: P19
artifact_path: docs/etl/sprints/AI-OPS-17/reports/final-gate-parity.md
```
...
Output contract:
- docs/etl/sprints/AI-OPS-17/reports/tracker-row74-reconciliation-draft.md

Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/reports/tracker-row74-reconciliation-draft.md
- rg -n "line 74|TODO|PARTIAL|DONE|evidence" docs/etl/sprints/AI-OPS-17/reports/tracker-row74-reconciliation-draft.md
...
depends_on: [20]
parallel_group: P20
artifact_path: docs/etl/sprints/AI-OPS-17/reports/tracker-row74-reconciliation-draft.md
```
...
- docs/etl/sprints/AI-OPS-17/reports/tracker-row74-apply.md

Acceptance checks:
- rg -n "Posiciones declaradas \(programas\)" docs/etl/e2e-scrape-load-tracker.md
- test -f docs/etl/sprints/AI-OPS-17/reports/tracker-row74-apply.md
- rg -n "before|after|evidence" docs/etl/sprints/AI-OPS-17/reports/tracker-row74-apply.md
...
depends_on: [20,21]
parallel_group: P21
artifact_path: docs/etl/sprints/AI-OPS-17/reports/tracker-row74-apply.md
```
...
- rg -n "Sprint Verdict|G1|G6|next sprint trigger|NO_ESCALATION" docs/etl/sprints/AI-OPS-17/closeout.md
...
Objective:
- Issue final PASS/FAIL verdict and lock AI-OPS-17 carryover policy.
...
Acceptance checks:
- test -f docs/etl/sprints/AI-OPS-17/closeout.md
- rg -n "Sprint Verdict|Gate Evaluation|next sprint trigger|NO_ESCALATION" docs/etl/sprints/AI-OPS-17/closeout.md
