# AI-OPS-12 T5 Final Gate + Parity
...
- `docs/etl/sprints/AI-OPS-12/reports/reconciliation-apply.md`
...
python3 scripts/export_explorer_sources_snapshot.py \
  --db etl/data/staging/politicos-es.db \
  --out docs/etl/sprints/AI-OPS-12/evidence/status-final.json
...
- `docs/etl/sprints/AI-OPS-12/evidence/tracker-status-final.log`
- `docs/etl/sprints/AI-OPS-12/evidence/tracker-gate-final.log`
- `docs/etl/sprints/AI-OPS-12/evidence/tracker-gate-final.exit`
- `docs/etl/sprints/AI-OPS-12/evidence/status-final.json`
- `docs/etl/sprints/AI-OPS-12/evidence/status-parity-summary.txt`
- `docs/etl/sprints/AI-OPS-12/evidence/final-integrity-metrics.csv`
- `docs/etl/sprints/AI-OPS-12/evidence/final-review-queue.csv`
...
## Baseline -> final delta (AI-OPS-12)
...
Scope outcome:
- six in-scope sources remain `PARTIAL` with refreshed blocker evidence and executable next commands.
- no tracker/sql mismatches were introduced.
