# Parlamento Vasco Strict-Network Timeout

Date: `2026-05-11`

Source: `parlamento_vasco_parlamentarios`
...
Next action:
- Retry from CI/live automation with bounded timeout evidence.
- If timeout persists, harden connector discovery or record a confirmed upstream access incident.
