...
Ahora: Workers Free + D1 creados; 47.397 filas normalizadas, 18.662 órganos/proveedores y búsqueda indexada. Destino: `/spending/` pide páginas de 12 resultados y opciones acotadas; mantiene fuentes y CSV voluntarios. Siguiente: verificar dominio público, paridad, CSV y ausencia de descarga completa automática.
...
- Compilación Next y privacidad pasan. Publicación de interfaz y navegador pendientes.
