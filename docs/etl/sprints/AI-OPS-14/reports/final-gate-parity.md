# AI-OPS-14 T6 Final Gate + Parity
...
- `docs/etl/sprints/AI-OPS-14/reports/reconciliation-apply.md`
...
python3 scripts/export_explorer_sources_snapshot.py \
  --db etl/data/staging/politicos-es.db \
  --out docs/etl/sprints/AI-OPS-14/evidence/status-final.json
...
with open('docs/etl/sprints/AI-OPS-14/evidence/final-integrity-metrics.csv', 'w', newline='', encoding='utf-8') as f:
    w = csv.DictWriter(f, fieldnames=list(row.keys())); w.writeheader(); w.writerow(row)
conn.close()
PY

sqlite3 -csv -header etl/data/staging/politicos-es.db "SELECT COUNT(*) AS topic_evidence_reviews_pending FROM topic_evidence_reviews WHERE lower(status)='pending';" > docs/etl/sprints/AI-OPS-14/evidence/final-review-queue.csv
```

## Evidence artifacts

- `docs/etl/sprints/AI-OPS-14/evidence/tracker-status-final.log`
- `docs/etl/sprints/AI-OPS-14/evidence/tracker-gate-final.log`
- `docs/etl/sprints/AI-OPS-14/evidence/tracker-gate-final.exit`
- `docs/etl/sprints/AI-OPS-14/evidence/status-final.json`
- `docs/etl/sprints/AI-OPS-14/evidence/status-parity-summary.txt`
- `docs/etl/sprints/AI-OPS-14/evidence/final-integrity-metrics.csv`
- `docs/etl/sprints/AI-OPS-14/evidence/final-review-queue.csv`
...
- `indicator_observation_records_total=0` (table absent in current DB snapshot; recorded via table-safe metric capture)
...
## Baseline -> final delta (AI-OPS-14)
...
Scope outcome:
- in-scope `PARTIAL` count: `4 -> 4`
- in-scope `DONE` count: `0 -> 0`
- no in-scope source transitioned to `DONE` in AI-OPS-14.
