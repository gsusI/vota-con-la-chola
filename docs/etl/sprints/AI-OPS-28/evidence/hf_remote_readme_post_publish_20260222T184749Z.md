...
- config_name: "admin_levels"
  ...
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/admin_levels/*.parquet"
- config_name: "causal_estimates"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/causal_estimates/*.parquet"
- config_name: "document_fetches"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/document_fetches/*.parquet"
- config_name: "domains"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/domains/*.parquet"
- config_name: "genders"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/genders/*.parquet"
- config_name: "indicator_observation_records"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/indicator_observation_records/*.parquet"
- config_name: "indicator_points"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/indicator_points/*.parquet"
- config_name: "indicator_series"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/indicator_series/*.parquet"
- config_name: "infoelectoral_archivos_extraccion"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/infoelectoral_archivos_extraccion/*.parquet"
- config_name: "infoelectoral_convocatoria_tipos"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/infoelectoral_convocatoria_tipos/*.parquet"
- config_name: "infoelectoral_convocatorias"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/infoelectoral_convocatorias/*.parquet"
- config_name: "infoelectoral_proceso_resultados"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/infoelectoral_proceso_resultados/*.parquet"
- config_name: "infoelectoral_procesos"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/infoelectoral_procesos/*.parquet"
- config_name: "ingestion_runs"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/ingestion_runs/*.parquet"
- config_name: "institutions"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/institutions/*.parquet"
- config_name: "intervention_events"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/intervention_events/*.parquet"
- config_name: "interventions"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/interventions/*.parquet"
- config_name: "mandates"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/mandates/*.parquet"
- config_name: "money_contract_records"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/money_contract_records/*.parquet"
- config_name: "money_subsidy_records"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/money_subsidy_records/*.parquet"
- config_name: "parl_initiative_doc_extractions"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/parl_initiative_doc_extractions/*.parquet"
- config_name: "parl_initiative_documents"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/parl_initiative_documents/*.parquet"
- config_name: "parl_initiatives"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/parl_initiatives/*.parquet"
- config_name: "parl_vote_event_initiatives"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/parl_vote_event_initiatives/*.parquet"
- config_name: "parl_vote_events"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/parl_vote_events/*.parquet"
- config_name: "parl_vote_member_votes"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/parl_vote_member_votes/*.parquet"
- config_name: "parties"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/parties/*.parquet"
- config_name: "party_aliases"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/party_aliases/*.parquet"
- config_name: "person_identifiers"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/person_identifiers/*.parquet"
- config_name: "persons"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/persons/*.parquet"
- config_name: "policy_axes"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/policy_axes/*.parquet"
- config_name: "policy_event_axis_scores"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/policy_event_axis_scores/*.parquet"
- config_name: "policy_events"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/policy_events/*.parquet"
- config_name: "policy_instruments"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/policy_instruments/*.parquet"
- config_name: "roles"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/roles/*.parquet"
- config_name: "sources"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/sources/*.parquet"
- config_name: "territories"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/territories/*.parquet"
- config_name: "text_documents"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/text_documents/*.parquet"
- config_name: "topic_evidence"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/topic_evidence/*.parquet"
- config_name: "topic_evidence_reviews"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/topic_evidence_reviews/*.parquet"
- config_name: "topic_positions"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/topic_positions/*.parquet"
- config_name: "topic_set_topics"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/topic_set_topics/*.parquet"
- config_name: "topic_sets"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/topic_sets/*.parquet"
- config_name: "topics"
  data_files:
  - split: train
    path:
    - "snapshots/2026-02-12/parquet/topics/*.parquet"
---
