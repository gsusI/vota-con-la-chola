...
- PARO.TASA.ES.M (replay): exit=1 reason=Traceback (most recent call last):   File "REPO_ROOT/vota-con-la-chola/scripts/ingestar_politicos_es.py", line 22, in <module>     raise SystemExit(main())                      ^^^^^^   File "REPO_ROOT/vota-con-la-chola/etl/politi
...
- TI.TMM.T.4F.EUR.4F.N.M (replay): exit=1 reason=Traceback (most recent call last):   File "REPO_ROOT/vota-con-la-chola/scripts/ingestar_politicos_es.py", line 22, in <module>     raise SystemExit(main())                      ^^^^^^   File "REPO_ROOT/vota-con-la-chola/etl/politi
