...
from .runtime import command_exit_code as _command_exit_code
from .runtime import ensure_playwright_nodejs_runtime as _ensure_playwright_nodejs_runtime
from .runtime import sanitize_runtime_path_for_public as _sanitize_runtime_path_for_public
from .statuses import HTTPStatusError
from .statuses import normalize_archive_fallback_http_statuses as _normalize_archive_fallback_http_statuses
from .statuses import normalize_http_status_filter as _normalize_http_status_filter
from .urls import canonical_url as _canonical_url
from .urls import dedupe_keep_order as _dedupe_keep_order
from .urls import exception_http_status as _exception_http_status
from .urls import maybe_decompress_gzip_payload as _maybe_decompress_gzip_payload
...
def backfill_initiative_documents_from_parl_initiatives(
    ...
    *,
    ...
    """
    from publicdata_sqlite.provenance import upsert_source_records_with_content_sha256  # noqa: PLC0415
