...
if(meta.release!==release.release||meta.version!==release.version||meta.rows!==release.rows||meta.amount_cents!==release.amount_cents)throw Error('Release mismatch');
