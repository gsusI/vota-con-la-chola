#!/usr/bin/env python3
"""Parity report for raw vs compacted packet-fix digest heartbeat (last-N window)."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Packet-fix digest heartbeat compaction-window report")
    p.add_argument(
        "--heartbeat-jsonl",
