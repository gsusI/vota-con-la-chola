#!/usr/bin/env python3
"""Compaction reporter for initdoc actionable-tail digest heartbeat JSONL."""
...
DEFAULT_COMPACTED_JSONL = Path("docs/etl/runs/initdoc_actionable_tail_digest_heartbeat.compacted.jsonl")
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Initdoc actionable-tail digest heartbeat compaction report")
    p.add_argument(
        "--heartbeat-jsonl",
