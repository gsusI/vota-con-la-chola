#!/usr/bin/env python3
"""Compaction reporter for citizen product KPI heartbeat JSONL."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Citizen product KPI heartbeat compaction report")
    p.add_argument(
        "--heartbeat-jsonl",
...
def build_compaction_report(
    ...
    *,
    ...
    for i, row in enumerate(rows):
        ...
        has_unknown_rate_violation = _is_threshold_violation(entry, key_ok="unknown_rate_within_threshold")
        has_tfa_violation = _is_threshold_violation(entry, key_ok="time_to_first_answer_within_threshold")
        has_drilldown_violation = _is_threshold_violation(entry, key_ok="drilldown_click_rate_within_threshold")
        ...
        if has_unknown_rate_violation:
            unknown_rate_violations_total += 1
            if i in selected_idx:
                unknown_rate_violations_selected += 1

        if has_tfa_violation:
            tfa_violations_total += 1
            if i in selected_idx:
                tfa_violations_selected += 1

        if has_drilldown_violation:
            drilldown_violations_total += 1
            if i in selected_idx:
                drilldown_violations_selected += 1
    ...
    report: dict[str, Any] = {
        ...
        "unknown_rate_violations_total": unknown_rate_violations_total,
        "unknown_rate_violations_selected": unknown_rate_violations_selected,
        "unknown_rate_violations_dropped": unknown_rate_violations_total - unknown_rate_violations_selected,
        "tfa_violations_total": tfa_violations_total,
        "tfa_violations_selected": tfa_violations_selected,
        "tfa_violations_dropped": tfa_violations_total - tfa_violations_selected,
        "drilldown_violations_total": drilldown_violations_total,
        "drilldown_violations_selected": drilldown_violations_selected,
        "drilldown_violations_dropped": drilldown_violations_total - drilldown_violations_selected,
        "anchors": {
        ...
        "checks": {
            ...
            "unknown_rate_violations_preserved_ok": unknown_rate_violations_total == unknown_rate_violations_selected,
            "tfa_violations_preserved_ok": tfa_violations_total == tfa_violations_selected,
            "drilldown_violations_preserved_ok": drilldown_violations_total == drilldown_violations_selected,
    ...
    if not report["checks"]["unknown_rate_violations_preserved_ok"]:
        reasons.append("unknown_rate_violation_rows_dropped")
    if not report["checks"]["tfa_violations_preserved_ok"]:
        reasons.append("tfa_violation_rows_dropped")
    if not report["checks"]["drilldown_violations_preserved_ok"]:
        reasons.append("drilldown_violation_rows_dropped")
