#!/usr/bin/env python3
"""Windowed trend report for initdoc compact-window digest heartbeat JSONL."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Initdoc compaction-window digest heartbeat window report")
    p.add_argument(
        "--heartbeat-jsonl",
