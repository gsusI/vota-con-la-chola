#!/usr/bin/env python3
"""Parity report for raw vs compacted packet-fix queue heartbeat (last-N window)."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Packet-fix queue heartbeat compaction-window report")
    p.add_argument(
        "--heartbeat-jsonl",
