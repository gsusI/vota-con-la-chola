#!/usr/bin/env python3
"""AI-OPS-215 compact strict digest over AI-OPS-214 compaction-window parity."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="AI-OPS-215 packet-fix compact strict digest report")
    p.add_argument(
        "--compaction-window-json",
        default=str(DEFAULT_COMPACTION_WINDOW_JSON),
        help=f"Path to AI-OPS-214 compaction-window JSON input (default: {DEFAULT_COMPACTION_WINDOW_JSON})",
    )
    p.add_argument(
        "--strict",
        action="store_true",
