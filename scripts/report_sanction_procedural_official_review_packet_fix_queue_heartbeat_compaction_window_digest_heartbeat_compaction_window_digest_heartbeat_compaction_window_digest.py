#!/usr/bin/env python3
"""Compact digest for packet-fix compact parity digest-heartbeat compaction-window parity."""
...
DEFAULT_COMPACTION_WINDOW_JSON = Path(
    "docs/etl/sprints/AI-OPS-202/evidence/"
    "sanction_procedural_official_review_packet_fix_queue_heartbeat_compaction_window_digest_heartbeat_compaction_window_digest_heartbeat_compaction_window_latest.json"
)


def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Packet-fix compact parity digest-heartbeat compaction-window digest report")
    p.add_argument(
