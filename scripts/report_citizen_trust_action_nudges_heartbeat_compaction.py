#!/usr/bin/env python3
"""Compaction reporter for citizen trust-action nudges heartbeat JSONL."""
...
DEFAULT_COMPACTED_JSONL = Path("docs/etl/runs/citizen_trust_action_nudges_heartbeat.compacted.jsonl")
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Citizen trust-action nudges heartbeat compaction report")
    p.add_argument(
        "--heartbeat-jsonl",
...
def build_compaction_report(
    ...
    *,
    ...
    nudge_clickthrough_violations_total = 0
    nudge_clickthrough_violations_selected = 0
    ...
    for i, row in enumerate(rows):
        ...
        has_nudge_clickthrough_violation = _is_threshold_violation(entry, key_ok="nudge_clickthrough_meets_minimum")
        ...
        if has_nudge_clickthrough_violation:
            nudge_clickthrough_violations_total += 1
            if i in selected_idx:
                nudge_clickthrough_violations_selected += 1
    ...
    report: dict[str, Any] = {
        ...
        "nudge_clickthrough_violations_total": nudge_clickthrough_violations_total,
        "nudge_clickthrough_violations_selected": nudge_clickthrough_violations_selected,
        "nudge_clickthrough_violations_dropped": nudge_clickthrough_violations_total - nudge_clickthrough_violations_selected,
        "anchors": {
        ...
        "checks": {
            ...
            "nudge_clickthrough_violations_preserved_ok": nudge_clickthrough_violations_total
            == nudge_clickthrough_violations_selected,
    ...
    if not report["checks"]["nudge_clickthrough_violations_preserved_ok"]:
        reasons.append("nudge_clickthrough_violation_rows_dropped")
