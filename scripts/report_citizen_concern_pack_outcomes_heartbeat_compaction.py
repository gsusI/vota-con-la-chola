#!/usr/bin/env python3
"""Compaction reporter for citizen concern-pack outcomes heartbeat JSONL."""
...
DEFAULT_COMPACTED_JSONL = Path("docs/etl/runs/citizen_concern_pack_outcomes_heartbeat.compacted.jsonl")
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Citizen concern-pack outcomes heartbeat compaction report")
    p.add_argument(
        "--heartbeat-jsonl",
...
def build_compaction_report(
    ...
    *,
    ...
    weak_pack_followthrough_violations_total = 0
    weak_pack_followthrough_violations_selected = 0
    unknown_pack_select_share_violations_total = 0
    unknown_pack_select_share_violations_selected = 0
    ...
    for i, row in enumerate(rows):
        ...
        has_followthrough_violation = _is_threshold_violation(entry, key_ok="weak_pack_followthrough_rate_meets_minimum")
        has_unknown_share_violation = _is_threshold_violation(entry, key_ok="unknown_pack_select_share_within_threshold")
        ...
        if has_followthrough_violation:
            weak_pack_followthrough_violations_total += 1
            if i in selected_idx:
                weak_pack_followthrough_violations_selected += 1

        if has_unknown_share_violation:
            unknown_pack_select_share_violations_total += 1
            if i in selected_idx:
                unknown_pack_select_share_violations_selected += 1
    ...
    report: dict[str, Any] = {
        ...
        "weak_pack_followthrough_violations_total": weak_pack_followthrough_violations_total,
        "weak_pack_followthrough_violations_selected": weak_pack_followthrough_violations_selected,
        "weak_pack_followthrough_violations_dropped": weak_pack_followthrough_violations_total - weak_pack_followthrough_violations_selected,
        "unknown_pack_select_share_violations_total": unknown_pack_select_share_violations_total,
        "unknown_pack_select_share_violations_selected": unknown_pack_select_share_violations_selected,
        "unknown_pack_select_share_violations_dropped": unknown_pack_select_share_violations_total - unknown_pack_select_share_violations_selected,
        "anchors": {
        ...
        "checks": {
            ...
            "weak_pack_followthrough_violations_preserved_ok": weak_pack_followthrough_violations_total
            == weak_pack_followthrough_violations_selected,
            "unknown_pack_select_share_violations_preserved_ok": unknown_pack_select_share_violations_total
            == unknown_pack_select_share_violations_selected,
    ...
    if not report["checks"]["weak_pack_followthrough_violations_preserved_ok"]:
        reasons.append("weak_pack_followthrough_violation_rows_dropped")
    if not report["checks"]["unknown_pack_select_share_violations_preserved_ok"]:
        reasons.append("unknown_pack_select_share_violation_rows_dropped")
