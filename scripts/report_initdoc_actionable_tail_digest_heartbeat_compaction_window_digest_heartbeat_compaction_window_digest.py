#!/usr/bin/env python3
"""Compact digest for initdoc cd-compact parity (raw-vs-compacted last-N)."""
...
try:
    ...
    from report_initdoc_actionable_tail_digest_heartbeat_compaction_window_digest import (
        build_compaction_window_digest,
    )
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Initdoc cd-compact parity digest report",
    )
    p.add_argument(
