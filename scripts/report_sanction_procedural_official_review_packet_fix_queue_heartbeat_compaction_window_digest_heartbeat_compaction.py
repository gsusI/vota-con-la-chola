#!/usr/bin/env python3
"""Compaction reporter for packet-fix compaction-window digest heartbeat JSONL."""
...
DEFAULT_HEARTBEAT_JSONL = Path(
    "docs/etl/runs/sanction_procedural_official_review_packet_fix_queue_heartbeat_compaction_window_digest_heartbeat.jsonl"
)
DEFAULT_COMPACTED_JSONL = Path(
    "docs/etl/runs/sanction_procedural_official_review_packet_fix_queue_heartbeat_compaction_window_digest_heartbeat.compacted.jsonl"
)
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Packet-fix digest heartbeat compaction report")
    p.add_argument(
        "--heartbeat-jsonl",
