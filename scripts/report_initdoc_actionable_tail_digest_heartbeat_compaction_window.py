#!/usr/bin/env python3
"""Parity report for raw vs compacted initdoc heartbeat (last-N window)."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Initdoc actionable-tail heartbeat compaction-window report")
    p.add_argument(
        "--heartbeat-jsonl",
