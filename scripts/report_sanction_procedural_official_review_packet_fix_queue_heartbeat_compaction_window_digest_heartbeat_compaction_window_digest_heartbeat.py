...
DEFAULT_DIGEST_JSON = Path(
    "docs/etl/sprints/AI-OPS-199/evidence/"
    "sanction_procedural_official_review_packet_fix_queue_heartbeat_compaction_window_digest_heartbeat_compaction_window_digest_latest.json"
)
DEFAULT_HEARTBEAT_JSONL = Path(
    "docs/etl/runs/"
    "sanction_procedural_official_review_packet_fix_queue_heartbeat_compaction_window_digest_heartbeat_compaction_window_digest_heartbeat.jsonl"
)
