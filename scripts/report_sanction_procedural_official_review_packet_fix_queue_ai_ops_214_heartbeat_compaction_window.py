#!/usr/bin/env python3
"""AI-OPS-214 parity report for raw vs compacted digest-heartbeat stream (last-N window)."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="AI-OPS-214 packet-fix digest-heartbeat compaction-window report")
    p.add_argument(
        "--heartbeat-jsonl",
