#!/usr/bin/env python3
"""Compact digest for packet-fix digest-heartbeat compaction-window parity."""
...
DEFAULT_COMPACTION_WINDOW_JSON = Path(
    "docs/etl/sprints/AI-OPS-198/evidence/"
    "sanction_procedural_official_review_packet_fix_queue_heartbeat_compaction_window_digest_heartbeat_compaction_window_latest.json"
)


def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Packet-fix digest-heartbeat compaction-window digest report")
    p.add_argument(
