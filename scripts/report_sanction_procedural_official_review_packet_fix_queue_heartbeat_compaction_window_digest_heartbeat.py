#!/usr/bin/env python3
"""Append-only heartbeat lane for packet-fix compaction-window digest."""
...
DEFAULT_DIGEST_JSON = Path(
    "docs/etl/sprints/AI-OPS-196/evidence/"
    "sanction_procedural_official_review_packet_fix_queue_heartbeat_compaction_window_digest_latest.json"
)
