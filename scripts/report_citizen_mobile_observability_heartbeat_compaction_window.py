#!/usr/bin/env python3
"""Parity report for raw vs compacted citizen mobile observability heartbeat (last-N window)."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Citizen mobile observability heartbeat compaction-window report")
    p.add_argument(
        "--heartbeat-jsonl",
...
def _to_ref(row: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "p90_within_threshold": p90_within_threshold,
...
def _has_incident(ref: dict[str, Any]) -> bool:
    ...
    if len(_safe_list_str(ref.get("strict_fail_reasons"))) > 0:
        return True
    if ref.get("p90_within_threshold") is False:
        return True
    return False
...
def _sample_ref(ref: dict[str, Any], *, present: bool) -> dict[str, Any]:
    return {
        ...
        "p90_within_threshold": ref.get("p90_within_threshold"),
...
def build_compaction_window_report(
    ...
    *,
    ...
    report: dict[str, Any] = {
        ...
        "raw_window_p90_threshold_violations": 0,
        ...
        "p90_violations_present_in_compacted": 0,
        "p90_violations_missing_in_compacted": 0,
        ...
        "checks": {
            ...
            "p90_violations_parity_ok": False,
    ...
    for ref in raw_window_refs:
        ...
        is_p90_violation = ref.get("p90_within_threshold") is False
        ...
        if is_p90_violation:
            report["raw_window_p90_threshold_violations"] += 1
        ...
        if present:
            ...
            if is_p90_violation:
                report["p90_violations_present_in_compacted"] += 1
        else:
            ...
            if is_p90_violation:
                report["p90_violations_missing_in_compacted"] += 1
    ...
    checks["p90_violations_parity_ok"] = (
        report["p90_violations_present_in_compacted"] >= report["raw_window_p90_threshold_violations"]
    )
    ...
    if not checks["p90_violations_parity_ok"]:
        reasons.append("p90_violations_underreported_in_compacted")
