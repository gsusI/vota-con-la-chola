#!/usr/bin/env python3
"""AI-OPS-214 compaction reporter for packet-fix digest-heartbeat continuity JSONL."""
...
DEFAULT_HEARTBEAT_JSONL = Path(
    "docs/etl/runs/sanction_procedural_official_review_packet_fix_queue_heartbeat_compaction_window_digest_heartbeat_compaction_window_digest_heartbeat_compaction_window_digest_heartbeat_compaction_window_digest_heartbeat_compaction_window_digest_heartbeat.jsonl"
)
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="AI-OPS-214 packet-fix digest-heartbeat compaction report")
    p.add_argument(
        "--heartbeat-jsonl",
