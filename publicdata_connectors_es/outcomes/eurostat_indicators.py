...
from publicdata_core.util import normalize_key_part, normalize_ws, now_utc_iso, sha256_bytes, stable_json


EUROSTAT_DEFAULT_URL = "https://ec.europa.eu/eurostat/api/dissemination/statistics/1.0/data/"
