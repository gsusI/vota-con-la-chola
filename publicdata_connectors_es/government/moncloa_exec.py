...
from publicdata_core.util import clean_text, normalize_ws, now_utc_iso, sha256_bytes, stable_json
...
SOURCE_DEFINITIONS: tuple[SourceDefinition, ...] = (
    SourceDefinition(
        ...
        scope="ejecutivo",
        default_url=MONCLOA_REFERENCIAS_INDEX_URL,
        format="html",
    ...
    SourceDefinition(
        ...
        scope="ejecutivo",
        default_url=MONCLOA_RSS_TIPO16_URL,
        format="xml",
