...
from publicdata_connectors_es.representatives.parsers import parse_asamblea_madrid_ocupaciones_csv
from publicdata_core.types import Extracted
from publicdata_core.util import normalize_ws, parse_date_flexible, pick_value, sha256_bytes, stable_json
